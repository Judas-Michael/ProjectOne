...
public class NoteBase {
        ...
        protected static final String DB_NAME = "notes.db";

        protected static final int DB_VERSION = 1;
        protected static final String DB_TABLE = "Tagged";

        private static final String INT_COL = "_id";
        protected static final String NAME_COL = "Note";
        protected static final String QUANTITY_COL = "Tag";

        private static final String DB_TAG = "DatabaseManager" ;
        private static final String SQL_TAG = "SQLHelper" ;

        public NoteBase(Context c) {
            this.context = c;
        ...
        public int getTags(String productName) {
